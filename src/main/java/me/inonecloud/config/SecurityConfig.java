...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                    .antMatchers("/", "/login**", "/js/**", "/error**", "/css/**", "/img/**", "/signUp", "/swagger-ui.html/**", "/storages/**", "/v2/api-docs", "/webjars/**", "/swagger-resources/**", "https://cloud-api.yandex.net/**", "/actuator/**").permitAll()
