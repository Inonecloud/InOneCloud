...
public class FilesService {
    ...
    public FilesService(DropboxRepository dropboxRepository, YandexRepository yandexRepository, TokensRepository tokensRepository, UserRepository userRepository) {
